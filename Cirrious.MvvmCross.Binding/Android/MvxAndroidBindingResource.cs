        ...
        : IMvxServiceConsumer<IMvxAndroidGlobals>
    {
        ...
        private MvxAndroidBindingResource()
        {
            ...
            try
            {
                ...
                BindableSpinnerStylableGroupId = (int[])resourceType.GetNestedType("Styleable").GetField("MvxBindableSpinner").GetValue(null);
                BindableSpinnerItemTemplateId = (int)resourceType.GetNestedType("Styleable").GetField("MvxBindableSpinner_MvxSpinnerTemplate").GetValue(null);
            }
        ...
        public int[] BindableSpinnerStylableGroupId { get; private set; }
        public int BindableSpinnerItemTemplateId { get; private set; }
